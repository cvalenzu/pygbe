...
def SA_wrap_arr(np.ndarray[REAL, ndim = 1, mode = "c"] y, 
                   np.ndarray[REAL, ndim = 1, mode = "c"] x,
		   ...
		   REAL kappa,
                   np.ndarray[int, ndim = 1, mode = "c"] same, 
                   np.ndarray[REAL, ndim = 1, mode = "c"] xk,
                   np.ndarray[REAL, ndim = 1, mode = "c"] wk):
...
def P2P_c(np.ndarray[REAL, ndim = 1, mode = "c"] MY, 
		   ...
		   np.ndarray[REAL, ndim = 1, mode = "c"] dML, 
                   np.ndarray[REAL, ndim = 1, mode = "c"] triangle, 
                   np.ndarray[int, ndim = 1, mode = "c"] tri,
                   np.ndarray[int, ndim = 1, mode = "c"] k, 
                   np.ndarray[REAL, ndim = 1, mode = "c"] xi,
                   np.ndarray[REAL, ndim = 1, mode = "c"] yi,
		   np.ndarray[REAL, ndim = 1, mode = "c"] zi,
		   np.ndarray[REAL, ndim = 1, mode = "c"] s_xj,
		   np.ndarray[REAL, ndim = 1, mode = "c"] s_yj,
		   np.ndarray[REAL, ndim = 1, mode = "c"] s_zj,
		   np.ndarray[REAL, ndim = 1, mode = "c"] xt,
		   np.ndarray[REAL, ndim = 1, mode = "c"] yt,
		   np.ndarray[REAL, ndim = 1, mode = "c"] zt,
		   np.ndarray[REAL, ndim = 1, mode = "c"] m,
		   np.ndarray[REAL, ndim = 1, mode = "c"] mx,
		   np.ndarray[REAL, ndim = 1, mode = "c"] my,
		   np.ndarray[REAL, ndim = 1, mode = "c"] mz,
		   np.ndarray[REAL, ndim = 1, mode = "c"] mclean,
		   np.ndarray[int, ndim = 1, mode = "c"] target,
		   np.ndarray[REAL, ndim = 1, mode = "c"] Area,
		   np.ndarray[REAL, ndim = 1, mode = "c"] xk,
		   np.ndarray[REAL, ndim = 1, mode = "c"] wk,
		   REAL kappa,
		   REAL threshold, 
